...
import adminPressCenterVideoRouter from "./routes/admin/admin_pressCenterVideo.js";
import pressCenterVideoRouter from "./routes/GetQuery/pressCenterVideo.js";
...
import adminManagementSystemRouter from "./routes/admin/admin_managementSystem.js";
import managementSystemRouter from "./routes/GetQuery/managementSystem.js";
...
app.use("/admin/admin_pressCenterVideo", adminPressCenterVideoRouter);
...
app.use("/admin/managementSystem", adminManagementSystemRouter);
...
app.use("/admin/pressCenterVideo", pressCenterVideoRouter);
app.use("/admin/documents_edi", documentsEDIRouter);
app.use("/admin/gratitude_get", gratitudeRouter);
app.use("/admin/managementSystem_get", managementSystemRouter);
